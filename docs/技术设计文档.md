...
```
packages/rule-engine : 51 tests passed（20 条规则 + 器件直连 + 教学说明完整性 + 引脚真实性 + 可复现性）
apps/web             : 43 tests passed（含 M-01 项目管理、FR-15 历史 12 例、器件直连 4 例、示例模板 6 例）+ 真实浏览器冒烟 37 项 passed（0 控制台错误）
