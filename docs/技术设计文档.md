...
```
packages/rule-engine : 41 tests passed（19 条规则 + 教学说明完整性 + 引脚真实性 + 可复现性 + RuleConfig）
apps/web             : 33 tests passed（含 M-01 项目管理 14 例、FR-15 历史 12 例）+ 真实浏览器冒烟 25 项 passed（0 控制台错误）
